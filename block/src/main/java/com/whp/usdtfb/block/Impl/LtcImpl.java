 ...
 */
@Service
public class LtcImpl implements LtcInterface {
    @Autowired
    private YuanShiInterface yuanShiInterface;
    @Autowired
    private FbUsdtDao fbUsdtDao;

    private String url = "http://47.91.217.242:9215";
    private String username = "ltc@bitcoin";
