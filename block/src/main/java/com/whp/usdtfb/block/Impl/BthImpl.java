 ...
 */
@Service
public class BthImpl implements BthInterface {
    @Autowired
    private YuanShiInterface yuanShiInterface;
    @Autowired
    private FbUsdtDao fbUsdtDao;

    private String url = "http://47.91.217.242:9214";
    private String username = "bch@bitcoin";
